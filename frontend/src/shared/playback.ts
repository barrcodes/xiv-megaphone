import type { CreateStreamRequest } from "./models";

export type AudioClass = "npc" | "chat" | "flavor";

export type CancelScope = "npc" | "chat" | "flavor" | "all";
...
export type IpcEventType = string;

export enum DialogueEventReason {
  TextReceived,
  AddonShown,
...
export interface CancelScopePayload {
  scope: CancelScope;
}
