...
import { DEFAULT_PRESET } from '../../../frontend-shared/defaults'
import type { Preset } from '../../../frontend-shared/types'
...
export function getActivePresetId(): string {
  ...
  const data = JSON.parse(readFileSync(activeFile, 'utf-8')) as { activePresetId: string }
