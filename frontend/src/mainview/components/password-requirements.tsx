...
export function PasswordRequirements({ validation }: { validation: PasswordValidation }) {
  return (
    <div className="space-y-1.5 pt-1">
      <Requirement met={validation.minLength} label="At least 8 characters" />
      <Requirement met={validation.hasUpper} label="One uppercase letter" />
      <Requirement met={validation.hasLower} label="One lowercase letter" />
