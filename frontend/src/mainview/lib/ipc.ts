...
export const getUseLocalBackend = (): Promise<{ enabled: boolean }> => api.getUseLocalBackend();
export const setUseLocalBackend = (en: boolean): Promise<void> => api.setUseLocalBackend(en);
